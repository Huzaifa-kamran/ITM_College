...
(function($) {
    ...
    versionSelect.on('change', function() {
		...
		/* if(this.value === 'dark'){
			...
			jQuery(".nav-header .logo-compact").attr("src", "../edumin/images/logo-text-white.png");
			jQuery(".nav-header .brand-title").attr("src", "../edumin/images/logo-text-white.png");
			...
			jQuery(".nav-header .logo-compact").attr("src", "../edumin/images/logo-text.png");
			jQuery(".nav-header .brand-title").attr("src", "../edumin/images/logo-text.png");
    ...
    themeDirectionSelect.on('change', function() {
        ...
        if(html.attr('dir') === "rtl"){
            jQuery('.main-css').attr('href','../edumin/css/style-rtl.css');
		}else{
            jQuery('.main-css').attr('href','../edumin/css/style.css');
		}
